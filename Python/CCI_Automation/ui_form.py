...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        self.label.setText(QCoreApplication.translate("Widget", u"Please select what you need below:", None))
        self.pushButton.setText(QCoreApplication.translate("Widget", u"Choose File", None))
        self.label_2.setText(QCoreApplication.translate("Widget", u"No input file/folder selected.", None))
        self.pushButton_2.setText(QCoreApplication.translate("Widget", u"Choose Destination", None))
        self.label_3.setText(QCoreApplication.translate("Widget", u"No file destination selected", None))
        self.pushButton_3.setText(QCoreApplication.translate("Widget", u"Run", None))
        self.label_4.setText(QCoreApplication.translate("Widget", u"Plase type the output file name in the box below", None))
        self.label_5.setText("")
        self.checkBox.setText(QCoreApplication.translate("Widget", u"Cut-off Date (optional)", None))
        pass
    # retranslateUi
