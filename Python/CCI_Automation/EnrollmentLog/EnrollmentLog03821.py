...
def EnrollmentLog03821(final_data):       
    ...
    if 'DM' in final_data:
        ...
        #EXMESOINF
        INF_df = final_data['EXMESOINF'][['Subject','Event Group Label', 'Infusion Date (ig_EXMESOINF1.INFDAT)']].copy()
        ...
        #INITLF Retx
        INITLF_df = final_data['DSINITLF'][['Subject','From which Phase is the Subject entering Long-Term Follow-Up? (ig_DSINITLF1.DSPHASE)', 'Last Study Visit Completed in Retreatment (ig_DSINITLF1.DSLVCRETX)', 'End of Retreatment Date (ig_DSINITLF1.DSENRETXDAT)']].copy()
        INITLF_df = INITLF_df[INITLF_df['From which Phase is the Subject entering Long-Term Follow-Up? (ig_DSINITLF1.DSPHASE)'] == 'Retreatment']
